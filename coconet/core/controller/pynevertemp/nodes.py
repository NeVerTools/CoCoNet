...
class BatchNormNode(LayerNode):
    ...
    def __init__(self, identifier: str, in_dim: Tuple, num_features: int, weight: Tensor = None, bias: Tensor = None,
        ...
        if not (num_features == in_dim[0]):
            raise Exception("The value of num_features should be equal to the first dimension of in_dim")
