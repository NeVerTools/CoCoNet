...
from PyQt5.QtWidgets import QGraphicsLineItem, QGraphicsRectItem, QGraphicsTextItem, QGraphicsPolygonItem, QVBoxLayout, \
    QWidget, QGridLayout, QGraphicsProxyWidget, QAction
from pynever.tensor import Tensor

import coconet.view.styles as style
import coconet.view.util.utility as u
from coconet.view.widget.custom import CustomLabel
