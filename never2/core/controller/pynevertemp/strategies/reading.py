...
import never2.core.controller.pynevertemp.strategies.processing as proc
from never2.core.controller.pynevertemp.tensor import Tensor
from never2.core.controller.pynevertemp.strategies.verification import SMTLIBProperty, NeVerProperty
...
class SmtPropertyParser:
    ...
    def get_components_of(self, vec_name: str) -> list:
        ...
        for d in declarations:
            v = str(d.args[0])  # args[0] contains the variable name, e.g., 'X_0'
